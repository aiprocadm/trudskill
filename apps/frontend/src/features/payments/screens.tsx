    ...
    ask(
      {
        ...
        tone: 'danger',
        /*
         * CMP-005: отменённый заказ не вернуть, а за ним стоит оплата обучения. Просим
         * переписать покупателя — подтверждается и намерение, и что отменяется тот заказ.
         */
        requireTyping: {
          word: label,
          label: 'Введите покупателя, чтобы подтвердить отмену',
          hint: `Покупатель отменяемого заказа: ${label}`
        }
      },
