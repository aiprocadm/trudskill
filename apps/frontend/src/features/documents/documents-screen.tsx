...
/*
 * Перенесён «как есть» из app/documents/page.tsx (766 строк — крупнейший файл приложения;
 * ТЗ §8.2, правило SCR-001: перенос и редизайн — разные шаги). Здесь его наконец видит
 * расширенный сторож единых состояний (IA-001). Разбор на секции и редизайн под TPL-001 —
 * следующий срез.
 */
    ...
    <PageContainer>
      ...
      <SectionCard title="Версия шаблона, переменные и привязки">
        <p className="ui-text-muted">
          Выберите шаблон в списке ниже (поле «Выберите шаблон» в блоке генерации), загрузите бланк
          в формате <code>.docx</code> — система создаст новую версию, сделает её активной и
