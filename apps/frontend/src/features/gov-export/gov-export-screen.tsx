  ...
  return (
    <PageContainer>
      ...
      <SectionCard title="ЕИСОТ — лица на тестирование (Минтруд)">
        ...
        {eisotOutcome ? (
          <div>
            ...
            {eisotOutcome.readiness ? <ReadinessNotice readiness={eisotOutcome.readiness} /> : null}
      ...
      <SectionCard title="Минздрав-НМО — непрерывное медобразование (ЗЕТ)">
        <p role="note" className="ui-callout ui-callout--warning" style={{ margin: '0 0 12px' }}>
          ⚠️ Формат выгрузки предварительный (не сверен с эталоном портала НМО). Специальность и ЗЕТ
          требуют проверки перед подачей.
        </p>
        <FilterBar>
          <input
            type="date"
