    ...
    ask(
      {
        ...
        tone: 'danger',
        /*
         * CMP-005: отзыв необратим, и без действующей лицензии центр не может публиковать
         * программы. Цвет кнопки руку не останавливает: в списке из двадцати строк промах на
         * одну — обычное дело. Просим переписать НОМЕР — так подтверждается и намерение, и то,
         * что выбрана та самая лицензия.
         */
        requireTyping: {
          word: license.licenseNumber,
          label: 'Введите номер лицензии, чтобы подтвердить отзыв',
          hint: `Номер отзываемой лицензии: ${license.licenseNumber}`
        }
      },
