...
export const TOP_JOB_ROUTES: Record<string, TopJobRoute> = {
  ...
  'Написать преподавателю': { href: '/chat', stepsInside: 1 }
};
 ...
 *
 * 0 — это и есть домашний экран; 1 — пункт главного меню; 2 — пункт в «Ещё» (сначала
 * раскрыть «Ещё», потом выбрать) или дочерний раздел пункта главного меню.
 */
