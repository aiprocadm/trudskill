...
const EXPLAINED: Record<string, string> = {
  ...
  /*
   * «Группы» (реестр) вычеркнуты в ТЗ 5.4 (Э4): кнопка «Закрыть N групп» в панели массового
   * закрытия перестала быть акцентной — действие необратимо и рисуется красным. Первичная на
   * экране осталась одна, «Создать группу», и объяснение стало ложным.
   */
