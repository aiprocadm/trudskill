...
/**
 * Поля авторства, которые не показаны, — с причиной.
 *
 ...
 *
 * Пусто с §5.432: показаны все четыре — кто разобрал сообщение, кто решил по переаттестации,
 * кто собрал выгрузку в государственный реестр и кто завёл шаблон отчёта.
 */
