...
const PLANNED_ROLES: Record<string, string> = {
  teacher:
    'роль преподавателя названа в ТЗ §4.4 и имеет чертёж меню, но миграции её не заводят: ' +
    'решение «заводить ли отдельную роль или обойтись методистом» за владельцем (журнал 21)'
};
