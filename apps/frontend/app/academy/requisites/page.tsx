...
export default function AcademyRequisitesPage() {
   ...
   * только администрация центра (право заведено миграцией 0083). Экран закрыт тем же
   * правом (журнал 343): прежде он был открыт по `tenant.read`, которое есть у всех ролей,
   * включая слушателя, — и «Реквизиты учебного центра» висели у слушателя в меню «Ещё».
   * Проверка права на форму оставлена: карта доступа и экран не должны расходиться молча.
   */
