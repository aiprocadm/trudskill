export type EsignApplicationStatus =
  | 'draft'
  | 'submitted'
  | 'under_review'
  | 'approved'
...
export type SigningProcessStatus =
  | 'draft'
  | 'prepared'
  ...
  | 'failed'
  | 'cancelled';
export type SigningParticipantStatus =
  | 'pending'
  | 'invited'
  | 'viewed'
  | 'signed'
...
export interface EsignApplicationEntity {
  id: string;
  tenantId: string;
  learnerId: string;
...
export interface EsignApplicationFileEntity {
  id: string;
  tenantId: string;
...
export interface SigningParticipantEntity {
  id: string;
  tenantId: string;
  processId: string;
...
export interface SignatureEventEntity {
  id: string;
  tenantId: string;
  processId: string;
...
export interface LegalLogEntryEntity {
  id: string;
  tenantId: string;
  actorId?: string;
  entityType: string;
