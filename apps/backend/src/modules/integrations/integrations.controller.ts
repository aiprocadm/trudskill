...
export class IntegrationsController {
  ...
  @Get('providers') listProviders(@Query() query: ListQueryDto) { return this.orchestrator.listProviders(query); }
  ...
  @Get('credentials') listCredentials(@CurrentContext() ctx: RequestContext, @Query() query: ListQueryDto) { return this.orchestrator.listCredentials(ctx.tenantId!, query); }
...
export class ExportsController {
  ...
  @Get('tasks') listTasks(@CurrentContext() ctx: RequestContext, @Query() query: ListQueryDto) { return this.orchestrator.listTasks(ctx.tenantId!, query); }
...
export class SyncLogsController {
  constructor(private readonly orchestrator: IntegrationOrchestratorService) {}
  @Get() list(@CurrentContext() ctx: RequestContext, @Query() query: ListQueryDto) { return this.orchestrator.listSyncLogs(ctx.tenantId!, query); }
  @Get('by-entity') byEntity(@CurrentContext() ctx: RequestContext, @Query('entity_type') entityType: string, @Query('entity_id') entityId: string) { return this.orchestrator.byEntity(ctx.tenantId!, entityType, entityId); }
  @Get('by-provider') byProvider(@CurrentContext() ctx: RequestContext, @Query('provider_code') providerCode: string) { return this.orchestrator.byProvider(ctx.tenantId!, providerCode); }
