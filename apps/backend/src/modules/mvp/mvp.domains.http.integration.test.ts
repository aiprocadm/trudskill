...
describe('MVP HTTP integration (domain invariants)', () => {
  ...
  beforeAll(async () => {
    ...
    const [
      ...
      import('./groups/group-wizard.service.js'),
      ...
      import('./infrastructure/repositories/in-memory-exam-results.repository.js'),
    ...
    @Module({
      ...
      providers: [
        ...
        { provide: EXAM_RESULTS_REPOSITORY, useValue: new InMemoryExamResultsRepository([]) },
        MvpNormalizedReadsService,
