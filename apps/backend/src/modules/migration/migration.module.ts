...
import { NormalizedBackfillService } from './backfill/normalized/normalized-backfill.service.js';
...
@Module({
  ...
  providers: [BackfillService, NormalizedBackfillService, WorkerCallbackGuard],
