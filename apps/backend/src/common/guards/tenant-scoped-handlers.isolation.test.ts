...
const WITHOUT_TENANT: ReadonlyArray<Allowed> = [
  ...
  /*
   * МГ-D1.2 (срез 13.1): подсказка реквизитов по ИНН читает общий государственный реестр
   * (ЕГРЮЛ через провайдера), а не данные центра; ответ одинаков для любого арендатора.
   */
  {
  ...
  /* МГ-E2.1 (срез 16.1): виды документов ФИС ФРДО для выбора у курса — общий справочник. */
  {
    ...
    why: 'справочник видов документов ФИС ФРДО — один на платформу, данных центра нет'
  },
  /*
