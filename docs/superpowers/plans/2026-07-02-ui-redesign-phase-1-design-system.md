...
8. **Порядок выполнения:** задачи 6–11 реализованы контроллером инлайн (сбой диспетчера субагентов), затем прошли spec+quality ревью постфактум; полный список known issues — handoff §5.162 (изначально §5.155, перенумерована при merge origin/main — аудит-ветки заняли §5.154–§5.161).
