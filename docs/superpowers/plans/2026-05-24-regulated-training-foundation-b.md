...
- [x] **Step 5: Run full backend test suite to confirm nothing broke**
...
- [x] **Step 1: Write the type-existence test**
...
- [x] **Step 3: Add types to `documents.types.ts`**
...
- [x] **Step 4: Re-export from mvp.types.ts for cross-module use**
...
- [x] **Step 1: Inspect existing DTO validation pattern**
...
- [x] **Step 2: Write DTO validation test**
...
- [x] **Step 4: Add exports and assertions to `documents.dto.ts`**
...
- [x] **Step 5: Wire assertions into existing handlers**
...
- [x] **Step 1: Inspect Enrollment shape**
...
- [x] **Step 4: Add resolvers to `pillar-a-variables.ts`**
...
- [x] **Step 5: Register `enrollment` + `document` in `variableCategories` Set**
...
- [x] **Step 3: Add resolver to `pillar-a-variables.ts`**
...
- [x] **Step 4: Register `group_learners` in `variableCategories` Set**
...
- [x] **Step 1: Inspect existing `listDocuments` method to match signature style**
...
- [x] **Step 4: Implement `listIssuedDocuments`**
...
- [x] **Step 4: Implement the endpoints in `documents.controller.ts`**
...
- [x] **Step 3: Implement `issueGroupOrder`**
...
- [x] **Step 3: Add endpoint to controller**
...
- [x] **Step 5: Create React Query hook**
...
- [x] **Step 6: Create the view component**
...
- [x] **Step 9: Run full frontend suite**
...
- [x] **Step 3: Add API methods to `mvp/api.ts`**
...
- [x] **Step 5: Wire the button into GroupDetailsScreen**
...
- [x] **Step 7: Run full frontend suite**
...
- [x] **Step 1: Read current state of file (мы уже видели первые 60 строк — найти JSX где `templateType`/`varCategory` рендерятся)**

Run: `grep -n "templateType\|varCategory" apps/frontend/app/documents/page.tsx`

- [x] **Step 2: Replace select markup for templateType**
...
- [x] **Step 3: Replace select markup for varCategory**
...
- [x] **Step 4: Manual sanity check (optional — no test for this)**
...
- [x] **Step 5: Run full frontend suite**
...
- [x] **Manual smoke checklist (optional)**
