...
| Администратор           | `/users`, `/admin/cockpit`, `/reports`, при необходимости `/integrations`                      | Пользователи/роли, KPI на `/reports`, отсутствие утечки данных в UI при смене tenant (только свой контекст)  |
