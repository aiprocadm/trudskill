...
2026-06-07 (фикс pre-existing e2e `aggregateReviewerQueue` snapshot-shape, §5.113, ветка fix/2026-06-07-reviewer-queue-e2e-snapshot от main post-#233; previous: Phase 5 Plan 5C §5.112 (слит #233); Plan 5B-2 §5.111; визуальная дизайн-система §5.110 PR #231; Phase 5 Plan 5B PR #229; Plan 5A #228, Wave 2 A/B/C #222-226)
