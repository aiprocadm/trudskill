...
- **Статус тестов (Cyrillic-path isolated `--no-file-parallelism`):** date-math 4/4; recert-drafts-repo 5/5; recert-service 7/7; documents.service 46/46; issuance-listener 11/11; email-notifications 13/13; mvp.http.integration 42/42; mvp.dto-validation 104/104 — **итого 232**. **Full `pnpm typecheck` 8/8** (не только isolated); ESLint clean по новым файлам.
