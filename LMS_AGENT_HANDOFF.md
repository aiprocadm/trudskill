...
- **Примечание по интеграции:** ветка `fix/2026-06-29-clear-vs-keep-edit-contract` от `d6dd915`; параллельный незакоммиченный батч в основном дереве также правит README §2 / этот файл — при мердже ожидается ручное разрешение нумерации §5.155.
