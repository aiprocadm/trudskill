...
- **Замечание:** это **параллельный PR** с §5.168 (PR #308, контейнеры) — оба правят статус-трекер/handoff, при слиянии второго возможен тривиальный конфликт в таблицах (журнал/сводка фаз) — разрешается объединением строк.
