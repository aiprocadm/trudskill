...
export const darkThemeVars = {
  '--ui-bg': '#1e293b',
  '--ui-surface': '#334155',
  '--ui-surface-muted': '#475569',
  '--ui-surface-accent': '#3b4f6d',
  '--ui-border': '#64748b',
  '--ui-text': '#f8fafc',
  ...
  '--ui-neutral-500': '#cbd5e1',
  '--ui-focus': '#60a5fa',
  '--ui-shadow': '0 1px 2px rgba(0, 0, 0, 0.28)',
  '--ui-shadow-strong': '0 10px 30px rgba(0, 0, 0, 0.38)',
  '--ui-nav-sidebar-bg': '#25344a',
  '--ui-nav-hover-bg': '#334961',
  '--ui-nav-active-bg': 'rgba(59, 130, 246, 0.22)',
  '--ui-nav-active-text': '#bfdbfe',
  '--ui-nav-text': '#f8fafc',
  '--ui-nav-text-muted': '#e2e8f0',
