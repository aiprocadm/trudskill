...
.ui-input,.ui-select,.ui-textarea,input,select,textarea { height: 40px; border: 1px solid var(--ui-border); border-radius: 12px; padding: 0 12px; background: var(--ui-surface); color: var(--ui-text); font-family: inherit; font-size: 0.95rem; transition: border-color .15s ease, box-shadow .15s ease; }
