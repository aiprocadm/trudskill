...
.learner-home-course { display: grid; gap: 9px; padding: 12px 14px; border-radius: 12px; transition: background .15s ease; }
...
.course-card { display: flex; flex-direction: column; gap: 12px; padding: 16px; border: 1px solid var(--ui-border); border-radius: 14px; background: var(--ui-surface); box-shadow: var(--ui-shadow); transition: border-color .15s ease, box-shadow .15s ease, transform .15s ease; }
...
.course-card__banner { height: 6px; border-radius: 999px; background: linear-gradient(90deg, var(--ui-brand-600), var(--ui-accent-600)); }
...
.ui-option { display: flex; align-items: center; gap: 10px; padding: 12px 14px; border: 1px solid var(--ui-border); border-radius: 12px; cursor: pointer; transition: border-color .15s ease, background .15s ease; }
...
.test-timer { display: inline-flex; align-items: center; gap: 6px; padding: 5px 12px; border-radius: 999px; font-weight: 700; font-variant-numeric: tabular-nums; background: var(--ui-surface-muted); color: var(--ui-text); border: 1px solid var(--ui-border); }
...
.test-result__banner { display: flex; align-items: center; gap: 16px; padding: 20px; border-radius: 16px; border: 1px solid var(--ui-border); }
...
button:focus-visible,input:focus-visible,select:focus-visible,textarea:focus-visible,a:focus-visible,summary:focus-visible { outline: 2px solid var(--ui-focus); outline-offset: 2px; border-radius: 8px; }
