...
export const documentsEndpoints = {
  templates: [
    ...
    '/templates/:id/set-current-version'
  ],
  templateVersions: [
    '/template-versions',
    '/template-versions/:id',
    '/template-versions/:id/activate',
    '/template-versions/:id/parse-variables'
  ],
  ...
  documentTasks: [
    '/document-tasks',
    '/document-tasks/:id',
    '/document-tasks/:id/retry',
    '/document-tasks/:id/cancel'
  ],
  numberingRules: [
    '/numbering-rules',
    '/numbering-rules/:id',
    '/numbering-rules/:id/activate',
    '/numbering-rules/:id/deactivate'
  ]
} as const;
