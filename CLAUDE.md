...
- **Migrations** are numbered SQL in [`apps/backend/migrations/`](apps/backend/migrations/). **Don't edit historical files.** Latest is `0074_iam_platform_impersonate_permission.sql` as of 2026-07-31. Pick the next number for new ones.
