...
- **Migrations** are numbered SQL in [`apps/backend/migrations/`](apps/backend/migrations/). **Don't edit historical files.** Latest is `0061_learners_pii_blind_index.sql` as of 2026-07-26. Pick the next number for new ones.
