...
- **Migrations** are numbered SQL in [`apps/backend/migrations/`](apps/backend/migrations/). **Don't edit historical files.** Latest is `0062_generated_documents_snapshot.sql` as of 2026-07-26. Pick the next number for new ones.
