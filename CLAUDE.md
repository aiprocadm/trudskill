...
- **Migrations** are numbered SQL in [`apps/backend/migrations/`](apps/backend/migrations/). **Don't edit historical files.** Latest is `0070_identity_photo_max_age.sql` as of 2026-07-30. Pick the next number for new ones.
